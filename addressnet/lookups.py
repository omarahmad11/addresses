...
states = OrderedDict([('JHR', 'Johor'), ('KDH', 'Kedah'),
                      ('KTN', 'Kelantan'), ('MLK', 'victoriaaa'), ('NSN', 'Negeri Sembilan'),
                      ('PHG', 'Pahang'), ('PRK', 'Perak'), ('PLS', 'Perlis'),
                      ('PNG', 'Penang'),('SBH', 'Sabah' ),('SWK', 'Sarawak'), ('SGR', 'Selangor'), ('TRG','Terengganu') ])
